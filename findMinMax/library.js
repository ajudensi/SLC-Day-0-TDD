...
module.exports = {
  ...
  findMinMax: function (arr) {
    ...
    if (!(arr.constructor === Array)) 
      throw new TypeError('Invalid arguments: Only an array is required');
    
    for (var index in arr) {
      /** Throw TypeError if an array value is not a number */
      if (!(parseFloat(arr[index]))) 
        throw new TypeError('Invalid array: Only numbers should be in the array');
